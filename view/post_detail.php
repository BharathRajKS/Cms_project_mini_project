    ...
    <div class="post">
        ...
        <div class="content">
            ...
            <div class="action-buttons" >
                ...
                <a href="/?id=<?php echo $post['id']; ?>" class="delete" onclick="return confirm('Are you sure you want to delete this post?');">Delete</a>
            </div>
            <?php endif; ?>
        </div>
    </div>
...
<div id="editModal" class="modal">
    <div class="modal-content">
        ...
        <h2>Edit Post</h2>
        <form id="editPostForm" method="POST" action="?id=<?php echo $post['id']; ?>" enctype="multipart/form-data">
